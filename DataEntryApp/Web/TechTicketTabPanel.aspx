<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TechTicketTabPanel.aspx.cs" Inherits="TechTicket.DataEntry.Web.EmailTemplateList" %>
...
<ext:TabPanel
    ...
    MarginSpec="0 0 20 0">
    <%--<DirectEvents>
        <TabChange OnEvent="OnTabChange" ></TabChange>
    </DirectEvents>--%>
    <Items>
