<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Request.ascx.cs" Inherits="DataEntryApp.UserControls.Request" %>

<ext:XScript runat="server" ID="XScript">
    <script>
        function validate() {
            var isValid = #{ requestWindow }.getForm().isValid();
            return isValid;
        }
...
<ext:Viewport ID="requestWindow" runat="server" Layout="BorderLayout" Padding="10" BodyPadding="5">
    <Items>
        <ext:TabPanel
            runat="server"
            Width="2000"
